...
export default function Footer() {
  return (
    <footer className="bg-cream py-12">
      <div className="container mx-auto px-4 md:px-8 text-center text-navy">
        <div className="flex justify-center mb-6">
          <ShieldLogo className="h-12 w-12 text-gold" />
        </div>
        <h3 className="text-2xl font-playfair mb-2">1322 Legacy Strategies</h3>
        <p className="mb-6">Control Your Capital. Build Your Legacy.</p>
        ...
        <div className="text-sm text-navy/70 space-x-6">
        ...
        <p className="text-xs text-navy/50 mt-8">
